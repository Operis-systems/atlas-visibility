...
export const GoldBtn: React.FC<GoldBtnProps> = ({
  ...
  return (
    <a href={href} style={{ ...base, ...variant, ...style }} onClick={onClick}>
      {children}
    </a>
  )
}
...
// ─── Animate on mount (for hero) ─────────────────────────────────────────────
export function useAnimateOnMount(ref: React.RefObject<HTMLElement>, delay = 0) {
  useEffect(() => {
